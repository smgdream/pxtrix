...
| [mdb_intact](mdb_intact/) | mandelbrot set interactive viewer | arg1: width of screen (px); arg2: height of screen (px); arg3: gamma;<br>e.g. a.out 3840 2160 0.3<br>This example must be run in Linux virtual terminal enviroment and make sure you can write framebuffer device.<br><br> Control:<br>exit: t<br> up: w<br> down: s<br> left: a<br> right:d<br> zoom in: =<br> zoom out: -<br> incerasing the number of iterations: ]<br> decreasing the number of iterations: [<br> default iterating times: 256 |
<!-- | 				|  | - | -->
<!-- 不用说明cat和crop -->
## Usage
