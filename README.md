...
NOTE: For Win, tar and sed of busybox version have something wrong. I using git
      version to compile it in Windows.
...
directory in the pxtrix's project directory. (include: *.a, *.o, 
*.exe,*.png, *.bmp, *.qoi, *.pgm, ect.)
$ make distclean
